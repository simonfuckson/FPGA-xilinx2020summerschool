...
#
# Generated by Vivado on Thu Jul 30 11:43:53 +0800 2020
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="F:/FPGA/summerschool/Camera_Demo/Camera_Demo/Camera_Demo.cache/compile_simlib/activehdl"
  fi
